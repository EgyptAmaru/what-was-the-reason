...
- **Purpose.** The TV board stays player-clean (an invariant); hints, host notes, and takeaways render only on the host's phone via host.html. The console also remote-controls the board: open/close cards, flip, winner selection, timer.
